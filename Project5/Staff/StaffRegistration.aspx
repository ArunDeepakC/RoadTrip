<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StaffRegistration.aspx.cs" Inherits="Staff_StaffRegistration" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="message-info"><h1 style="color:white;" align="center">Staff Registration!!</h1></div><br />
    ...
    <div>
        ...
        <asp:Button ID="btn_register" runat="server" Text="Register" OnClick="btn_register_Click1" Width="200px"/>
        </div>
        <br />
        <br />
